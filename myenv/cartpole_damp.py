...
class CartPoleEnv(gym.Env):
    ...
    def dynamics(self, t, y, u):
        ...
        thetaacc = (self.gravity * sintheta - costheta* temp - 0.2 * y[3]) / (self.length * (4.0/3.0 - self.masspole * costheta * costheta / self.total_mass))
        f[0] = y[1]
        f[1] = temp - self.polemass_length * thetaacc * costheta / self.total_mass
        f[2] = y[3]
        f[3] = thetaacc  # add damping on theta
        return f
