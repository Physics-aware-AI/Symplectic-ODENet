...
# This file is a script version of 'analyze-damp-acrobot.ipynb'
...
EXPERIMENT_DIR = './experiment-damp-acrobot/'
...
def get_model(args, baseline, structure, naive, damping, num_points, no_damp=False):
    ...
    if structure == False:
        if naive and baseline:
            ...
            nn_model = MLP(input_dim, 600, output_dim, args.nonlinearity)
...
plt.plot(t_linspace_model, symoden_struct_nodamp_ivp.y[0,:], 'c', label='Nodamp SymODEN')
...
plt.plot(t_linspace_model, symoden_struct_nodamp_ivp.y[2,:], 'c', label='Nodamp SymODEN')
...
plt.plot(t_linspace_model, symoden_struct_nodamp_ivp.y[4,:], 'c', label='Nodamp SymODEN')
...
plt.plot(t_linspace_model, symoden_struct_nodamp_ivp.y[1,:], 'c', label='Nodamp SymODEN')
...
plt.plot(t_linspace_model, symoden_struct_nodamp_ivp.y[3,:], 'c', label='Nodamp SymODEN')
...
plt.plot(t_linspace_model, symoden_struct_nodamp_ivp.y[5,:], 'c', label='Nodamp SymODEN')
